...
xst -ifn xst.scr
move ddr_clk_mod_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\ddr_clk_mod_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc ddr_clk_mod_exdes.ucf ddr_clk_mod_exdes

echo 'Running map'
map -timing -pr b ddr_clk_mod_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm ddr_clk_mod_exdes -w routed.ncd routed.v
cd ..
